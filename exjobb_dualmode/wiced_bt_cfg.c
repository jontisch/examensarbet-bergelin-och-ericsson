...
uint8_t BT_LOCAL_NAME[] = { 'e','x','j','o','b','b','_','d','u','a','l','m','o','d','e','\0' };
...
const wiced_bt_cfg_settings_t wiced_bt_cfg_settings =
{
    ...
    .security_requirement_mask =            BTM_SEC_IN_AUTHENTICATE | BTM_SEC_OUT_AUTHENTICATE | BTM_SEC_ENCRYPT,   /**< Security requirements mask (BTM_SEC_NONE, or combination of BTM_SEC_IN_AUTHENTICATE, BTM_SEC_OUT_AUTHENTICATE, BTM_SEC_ENCRYPT */
    .max_simultaneous_links =               3,                                                                      /**< Maximum number of simultaneous links to different devices */
    ...
    /* GATT Configuration */
    .gatt_cfg = {
        .appearance =                       APPEARANCE_GENERIC_COMPUTER,                                                                 /**< GATT Appearance */
